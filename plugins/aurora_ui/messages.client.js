 ...
 * @final
 */
aurora.messages.MAKE_HOLIDAY = recoil.ui.message.getParamMsg('Make Holiday');

/**
 * @type {!recoil.ui.message.Message}
 * @final
 */
aurora.messages.REMOVE_HOLIDAY = recoil.ui.message.getParamMsg('Remove Holiday');

/**
 * @type {!recoil.ui.message.Message}
 * @final
 */
aurora.messages.ADD_HOLIDAY = recoil.ui.message.getParamMsg('Add Holiday...');

/**
 * @type {!recoil.ui.message.Message}
 * @final
 */
aurora.messages.MODIFY_HOLIDAY_ELLIPSE = recoil.ui.message.getParamMsg('Modify Holiday...');

/**
 * @type {!recoil.ui.message.Message}
 * @final
 */
aurora.messages.START_DATE = recoil.ui.message.getParamMsg('Start Date');

/**
 * @type {!recoil.ui.message.Message}
 * @final
 */
aurora.messages.STOP_DATE = recoil.ui.message.getParamMsg('Stop Date');

/**
 * @type {!recoil.ui.message.Message}
 * @final
 */
aurora.messages.MODIFY_HOLIDAY = recoil.ui.message.getParamMsg('Modify Holiday');

/**
 * @type {!recoil.ui.message.Message}
 * @final
 */
aurora.messages.MODIFY = recoil.ui.message.getParamMsg('Modify');

/**
 * @type {!recoil.ui.message.Message}
 * @final
 */
aurora.messages.HOLIDAY = recoil.ui.message.getParamMsg('Holiday');
